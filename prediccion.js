...
// ---- Motor de predicción --------------------------------------------------
// La lógica pura (TF-IDF, similitud, ponderación) vive en engine.js, que se
// carga antes que este archivo y expone las funciones como globales
// (predecirCore, valorResultado, etiquetaResultado, etc.).

function predecir(caso, anioActual) {
  return predecirCore(fallos, caso, anioActual);
}
